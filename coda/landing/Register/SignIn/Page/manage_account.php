...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $update_query = "UPDATE faculties SET names = '$new_name', contact_no = '$new_contact_no', email = '$new_email', password = '$new_password', coordinator = '$new_coordinator', address = '$new_address' WHERE faculty_id = $faculty_id";
